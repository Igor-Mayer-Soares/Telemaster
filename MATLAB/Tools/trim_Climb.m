...
function [ClimbMax,vertAccLim,Pitch] = trim_Climb(Vcruise,throttle,model)
...
% - Default model initial conditions are used to initialize optimization.
opspec.Outputs(12).y     = 0;
opspec.Outputs(12).Known = false;
...
if opreport.TerminationString == "Operating point specifications were successfully met."
    ClimbMax = opreport.Outputs(12).y;
    vertAccLim = opreport.Outputs(3).y;
    Pitch = opreport.Outputs(22).y;
else
    ClimbMax = "Fail";
    vertAccLim = "Fail";
    Pitch = "Fail";
